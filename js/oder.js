function doimucgia() {
    var arrGia = document.getElementsByName("gia"); // lưu vào mảng
...
function tich1checkbox(i) {
    ...
    arrSL[i].disabled = !arrSL[i].disabled; // đảo trạng thái none thành block
...
function thanhtien(obj) {
    ...
    var gia = obj.parentNode.previousElementSibling.innerText; // lấy giá tiền, đối tượng ở trước
